<?php 
$user = $conn->query("SELECT * FROM student_list where id ='".$_settings->userdata('id')."'");
				...
				<form action="" id="manage-user">	
					...
					<div class="row">
						...
						<div class="form-group col-md-4">
                                ...
                                <input type="text" id="course" name="course" class="form-control form-control-sm form-control-border" value="<?= isset($course) ? $course : "" ?>" required>
                            </div>
                            <div class="form-group col-md-4">
                                <label for="department" class="control-label">Department</label>
                                <input type="text" id="department" name="department" class="form-control form-control-sm form-control-border" value="<?= isset($department) ? $department : "" ?>" required>
                            </div>
                            <div class="form-group col-md-4">
                                <label for="std_id" class="control-label">ID No. #</label>
                                <input type="text" id="std_id" name="std_id" class="form-control form-control-sm form-control-border" value="<?= isset($std_id) ? $std_id : "" ?>" required>
                            </div>
                        <div class="form-group col-md-4">
