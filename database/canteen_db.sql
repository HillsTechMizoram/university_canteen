...
INSERT INTO `category_list` (`id`, `canteen_id`, `name`, `description`, `status`, `delete_flag`, `date_created`, `date_updated`) VALUES
...
INSERT INTO `student_list` (`id`, `code`, `firstname`, `middlename`, `lastname`, `course`,  `department`,  `std_id`, `gender`, `contact`, `address`, `email`, `password`, `avatar`, `status`, `delete_flag`, `date_created`, `date_updated`) VALUES
(1, '202202-00001', 'John', 'D', 'Smith', 'Btech', 'CE', '345345345', 'Male', '09123456789', 'This is only my sample address', 'jsmith@sample.com', '1254737c076cf867dc53d60a0364f38e', 'uploads/clients/1.png?v=1644386016', 1, 0, '2022-02-09 13:53:36', '2022-02-10 13:42:53'),
(2, '202202-00002', 'test', 'test', 'test', 'Btech', 'IT', '354663463', 'Male', '094564654', 'test', 'test@sample.com', '098f6bcd4621d373cade4e832627b4f6', 'uploads/clients/2.png?v=1644471867', 1, 1, '2022-02-10 13:44:26', '2022-02-10 13:44:35');
...
INSERT INTO `order_list` (`id`, `code`, `client_id`, `canteen_id`, `total_amount`, `delivery_address`, `status`, `date_created`, `date_updated`) VALUES
...
CREATE TABLE `product_list` (
  `id` int(30) NOT NULL,
  `canteen_id` int(30) DEFAULT NULL,
...
INSERT INTO `product_list` (`id`, `canteen_id`, `category_id`, `name`, `description`, `price`, `image_path`, `status`, `delete_flag`, `date_created`, `date_updated`) VALUES
...
--
-- Table structure for table `canteen_dept`
--

CREATE TABLE `canteen_dept` (
  `id` int(30) NOT NULL,
  `name` text NOT NULL,
  `status` tinyint(1) NOT NULL DEFAULT 1,
  `delete_flag` tinyint(1) NOT NULL DEFAULT 0,
...
--
-- Dumping data for table `canteen_dept`
--

INSERT INTO `canteen_dept` (`id`, `name`, `status`, `delete_flag`, `date_created`, `date_updated`) VALUES
...
--
-- Table structure for table `canteen_list`
--

CREATE TABLE `canteen_list` (
  `id` int(30) NOT NULL,
  `code` varchar(100) NOT NULL,
  `canteen_dept_id` int(30) NOT NULL,
  `canteen_name` text NOT NULL,
  `canteen_owner` text NOT NULL,
  `contact` text NOT NULL,
  `username` text NOT NULL,
  `password` text NOT NULL,
  `avatar` text DEFAULT NULL,
...
--
-- Dumping data for table `canteen_list`
--

INSERT INTO `canteen_list` (`id`, `code`, `canteen_dept_id`, `canteen_name`, `canteen_owner`, `contact`, `username`, `password`, `avatar`, `status`, `delete_flag`, `date_created`, `date_updated`) VALUES
(1, '202202-00001', 4, 'Shop101', 'Shop 101 Owner', '09123456788', 'shop101', 'ee6c4d4ba80f29dd389f0deb8863de69', 'uploads/canteens/1.png?v=1644375053', 1, 0, '2022-02-09 10:50:53', '2022-02-10 13:43:21'),
(2, '202202-00002', 1, 'Shop102', 'John Miller', '09123456789', 'shop102', '90be022251077e3488c998613214df74', 'uploads/canteens/2.png?v=1644375129', 1, 0, '2022-02-09 10:52:09', '2022-02-09 17:02:54'),
(3, '202202-00003', 2, 'test', 'test', '123123123', 'test', '098f6bcd4621d373cade4e832627b4f6', 'uploads/canteens/3.png?v=1644471934', 1, 1, '2022-02-10 13:45:34', '2022-02-10 13:50:15');
...
--
-- Indexes for table `canteen_dept`
--
ALTER TABLE `canteen_dept`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `canteen_list`
--
ALTER TABLE `canteen_list`
  ADD PRIMARY KEY (`id`),
  ADD KEY `canteen_dept_id` (`canteen_dept_id`);
...
--
-- AUTO_INCREMENT for table `canteen_dept`
--
ALTER TABLE `canteen_dept`
...
--
-- AUTO_INCREMENT for table `canteen_list`
--
ALTER TABLE `canteen_list`
...
--
ALTER TABLE `cart_list`
  ADD CONSTRAINT `cart_list_ibfk_1` FOREIGN KEY (`client_id`) REFERENCES `student_list` (`id`) ON DELETE CASCADE,
...
--
ALTER TABLE `category_list`
  ADD CONSTRAINT `category_list_ibfk_1` FOREIGN KEY (`canteen_id`) REFERENCES `canteen_list` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `order_list`
  ADD CONSTRAINT `order_list_ibfk_1` FOREIGN KEY (`client_id`) REFERENCES `student_list` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `order_list_ibfk_2` FOREIGN KEY (`canteen_id`) REFERENCES `canteen_list` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `product_list`
--
ALTER TABLE `product_list`
  ADD CONSTRAINT `product_list_ibfk_1` FOREIGN KEY (`canteen_id`) REFERENCES `canteen_list` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `product_list_ibfk_2` FOREIGN KEY (`category_id`) REFERENCES `category_list` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `canteen_list`
--
ALTER TABLE `canteen_list`
  ADD CONSTRAINT `vendor_list_ibfk_1` FOREIGN KEY (`canteen_dept_id`) REFERENCES `canteen_dept` (`id`) ON DELETE CASCADE;
COMMIT;
