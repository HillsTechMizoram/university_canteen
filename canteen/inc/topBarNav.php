      ...
      <nav class="main-header navbar navbar-expand navbar-light text-sm shadow">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item d-none d-sm-inline-block">
            <a href="<?php echo base_url ?>" class="nav-link"><?php echo (!isMobileDevice()) ? $_settings->info('name'):$_settings->info('short_name'); ?>  - Canteen Admin</a>
          </li>
        </ul>
        <!-- Right navbar links -->
          ...
          <li class="nav-item">
            <div class="btn-group nav-link">
                  ...
                  <div class="dropdown-menu" role="menu">
                    <a class="dropdown-item" href="<?php echo base_url.'canteen/?page=user' ?>"><span class="fa fa-user"></span> My Account</a>
