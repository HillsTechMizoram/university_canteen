                    ...
                    <form id="vregister-frm" action="" method="post">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="canteen_name" autofocus name="canteen_name" class="form-control form-control-sm form-control-border" required>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="canteen_owner" class="control-label">Owner Fullname</label>
                                <input type="text" id="canteen_owner" name="canteen_owner" class="form-control form-control-sm form-control-border" required>
                            </div>
                            <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-6">
                                <label for="canteen_dept_id" class="control-label">Canteen Department</label>
                        ...
                        <div class="row align-item-end">
                            ...
                            <a href="<?= base_url.'canteen/login.php' ?>">Already have an Account</a>
                            </div>
                        <!-- /.col -->
                        </div>
                    </form>
