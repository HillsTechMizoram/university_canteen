...
if(isset($_GET['id']) && $_GET['id'] > 0){
    $qry = $conn->query("SELECT o.*,c.code as ccode, CONCAT(c.lastname, ', ',c.firstname,' ',COALESCE(c.middlename,'')) as client, CONCAT(v.code, '-',v.canteen_name) as `canteen` from `order_list` o inner join student_list c on o.client_id = c.id inner join canteen_list v on o.canteen_id = v.id where o.id = '{$_GET['id']}' ");
    if($qry->num_rows > 0){
...
<div class="container-fluid">
	<div class="row">
        ...
        <div class="col-3 border bg-gradient-primary"><span class="">Canteen</span></div>
        <div class="col-9 border"><span class="font-weight-bolder"><?= isset($canteen) ? $canteen : '' ?></span></div>
        <div class="col-3 border bg-gradient-primary"><span class="">Order From</span></div>
    ...
    <?php 
            ...
            <div class="d-flex align-items-center p-2">
                ...
                <div class="col-auto flex-shrink-1 flex-grow-1">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="col-auto px-0 flex-shrink-1 flex-grow-1"><p class="m-0 pl-3"><small class="text-primary"><i class="nav-icon fas fa-rupee-sign"></i><?= format_num($prow['price']) ?></small></p></div>
                    </div>
                    <div class="d-flex">
        ...
        <div class="col-12 border">
            <div class="d-flex">
                ...
                <div class="col-3 h4 font-weight-bold text-right"><i class="nav-icon fas fa-rupee-sign"></i> <?= format_num($gtotal) ?></div>
            </div>
        </div>
    </div>
