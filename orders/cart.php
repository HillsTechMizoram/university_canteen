            ...
            <div id="cart-list">
                ...
                ?>
                    <div class="col-12 border">
                        <span>Canteen: <b><?= $vrow['code']. " - " . $vrow['canteen_name'] ?></b></span>
                    </div>
                    <div class="col-12 border p-0">
                        <?php 
                        $vtotal = 0;
                        $products = $conn->query("SELECT c.*, p.name as `name`, p.price,p.image_path FROM `cart_list` c inner join product_list p on c.product_id = p.id where c.client_id = '{$_settings->userdata('id')}' and p.canteen_id = '{$vrow['id']}' order by p.name asc");
                        ...
                        <div class="d-flex align-items-center border p-2">
                            ...
                            <div class="col-auto flex-shrink-1 flex-grow-1">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="col-auto px-0 flex-shrink-1 flex-grow-1"><p class="m-0 pl-3"><small class="text-primary"><i class="fa fa-rupee-sign"></i><?= format_num($prow['price']) ?></small></p></div>
                                </div>
                                <div class="d-flex">
                    ...
                    <div class="col-12 border">
                        <div class="d-flex">
                            ...
                            <div class="col-3 text-right font-weight-bold"><i class="fa fa-rupee-sign"></i><?= format_num($vtotal) ?></div>
                        </div>
                    </div>
                <?php endwhile; ?>
                    <div class="col-12 border">
                        <div class="d-flex">
                            ...
                            <div class="col-3 h4 font-weight-bold text-right"><i class="fa fa-rupee-sign"></i><?= format_num($gtotal) ?></div>
                        </div>
                    </div>
                </div>
            </div>
