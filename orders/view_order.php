...
if(isset($_GET['id']) && $_GET['id'] > 0){
    $qry = $conn->query("SELECT o.*,v.canteen_name,v.code as vcode from `order_list` o inner join canteen_list v on o.canteen_id = v.id where o.id = '{$_GET['id']}' ");
    if($qry->num_rows > 0){
...
<div class="container-fluid">
	<div class="row">
        ...
        <div class="col-9 border"><span class="font-weight-bolder"><?= isset($canteen_name) ? $vcode.' - '.$canteen_name : '' ?></span></div>
