...
<body class="hold-transition">
  ...
  <div class="d-flex justify-content-center align-items-center flex-row h-100">
        <div class="col-5">
            ...
            <h1 class="text-center" id="system_name">University Online Canteen</h1>
        </div>
        <div class="col-7 h-100 bg-gradient-light px-4">
            <div class="d-flex justify-content-center align-items-center w-90 h-90">
                <div class="card card-outline card-primary col-15 rounded-0 shadow">
                    <div class="card-header text-center">
                    <a href="./register.php" class="h1"><b>Create Student Account</b></a>
                    </div>
                    <div class="card-body">
                    ...
                    <form id="cregister-frm" action="" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" id="course" name="course" class="form-control form-control-sm form-control-border" required>
                            </div>
                            <div class="form-group col-md-4">
                                <label for="department" class="control-label">Department</label>
                                <input type="text" id="department" name="department" class="form-control form-control-sm form-control-border" required>
                            </div>
                            <div class="form-group col-md-4">
                                <label for="std_id" class="control-label">ID No. #</label>
                                <input type="text" id="std_id" name="std_id" class="form-control form-control-sm form-control-border" required>
                            </div>
                            <div class="form-group col-md-4">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="logo" class="control-label">ID Image</label>
